package io.faizauthar12.github.revolusiindonesia.utils.dummy

import io.faizauthar12.github.revolusiindonesia.data.HeroEntity

object HeroDummy {
    fun generateHeroDummy(): List<HeroEntity> {
        val heroes = ArrayList<HeroEntity>()

        heroes.add(
            HeroEntity(
                heroName = "Soedirman",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Jenderal_Sudirman.jpg/565px-Jenderal_Sudirman.jpg",
        ...
        heroes.add(
            HeroEntity(
                heroName = "Ki Hadjar Dewantara",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/3/3a/Ki_Hadjar_Dewantara_Mimbar_Umum_18_October_1949_p2.jpg",
        ...
        heroes.add(
            HeroEntity(
                heroName = "Sutomo",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/e/ed/Bung_Tomo.jpg",
        ...
        heroes.add(
            HeroEntity(
                heroName = "Soekarno",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/0/01/Presiden_Sukarno.jpg",
        ...
        heroes.add(
            HeroEntity(
                heroName = "Gatot Soebroto",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/b/be/Col_Gatot_Subroto%2C_Kenang-Kenangan_Pada_Panglima_Besar_Letnan_Djenderal_Soedirman%2C_p27.jpg",
        ...
        heroes.add(
            HeroEntity(
                heroName = "Mohammad Hatta",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/3/3b/VP_Hatta.jpg",
        ...
        heroes.add(
            HeroEntity(
                heroName = "Ahmad Yani",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/3/3f/Ahmad_Yani.jpg",
                heroDescription = "Jenderal TNI (Anumerta) Ahmad Yani (juga dieja A. Yani, Achmad Yani; (19 Juni 1922 – 1 Oktober 1965) adalah Menteri/Panglima Angkatan Darat (KSAD) yang merupakan salah satu Pahlawan Revolusi yang gugur menjadi korban tragedi Gerakan 30 September dibunuh oleh anggota Gerakan 30 September saat mencoba untuk menculik dia dari rumahnya."
            )
        )
        ...
        heroes.add(
            HeroEntity(
                heroName = "Soepomo",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/a/a6/Supomo.jpg",
                heroDescription = "Prof. Dr. Mr. Soepomo (Ejaan Soewandi: Supomo; 22 Januari 1903 – 12 September 1958) adalah seorang pahlawan nasional Indonesia. Soepomo dikenal sebagai perancang Undang-undang Dasar 1945, bersama dengan Muhammad Yamin dan Soekarno."
            )
        )
        ...
        heroes.add(
            HeroEntity(
                heroName = "Tan Malaka",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/f/f7/TanMalaka_DariPendjara_ed3.jpg",
                heroDescription = "Tan Malaka atau Ibrahim Gelar Datuk Sutan Malaka (2 Juni 1897 – 21 Februari 1949) adalah seorang pejuang kemerdekaan Indonesia,[1] juga pendiri Partai Murba, dan merupakan salah satu Pahlawan Nasional Indonesia."
            )
        )

        heroes.add(
            HeroEntity(
                heroName = "Ahmad Dahlan",
                heroPicture = "https://upload.wikimedia.org/wikipedia/commons/8/87/Ahmad_Dahlan.jpg",
                heroDescription = "Kiai Haji Ahmad Dahlan atau Muhammad Darwis (1 Agustus 1868 – 23 Februari 1923) adalah seorang Ulama Besar bergelar Pahlawan Nasional Indonesia yang merupakan pendiri Muhammadiyah. Dia adalah putra keempat dari tujuh bersaudara dari keluarga K.H. Abu Bakar. KH Abu Bakar adalah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu, dan ibu dari K.H. Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu."
            )
        )
